...
<<<<<<< HEAD
nvcc -o LSQR_GPU lsqr_gpu/matmul/GPUVector.cu lsqr_gpu/matmul/SpMat.cu lsqr_gpu/main.cu -std=c++11 -lcublas -lcusparse
=======
nvcc -o LSQR_GPU lsqr_gpu/matmul/GPUVector.cu lsqr_gpu/matmul/SpMat.cu lsqr_gpu/main.cu -std=c++11 -lcublas
>>>>>>> cab6b29a8e2e5efb0f8f7a374e68ba5a8b3d9ee2
